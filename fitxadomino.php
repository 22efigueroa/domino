<?php
    ...
    case '1': imagefilledellipse($im, 20+$desfase, 20, 5, 5, $white);
    break;

    case '2': imagefilledellipse($im, 10+$desfase, 10, 5, 5, $white);
    imagefilledellipse($im, 30+$desfase, 30, 5, 5, $white);
    break;

    case '3': imagefilledellipse($im, 10+$desfase, 10, 5, 5, $white);
    imagefilledellipse($im, 20+$desfase, 20, 5, 5, $white);
    imagefilledellipse($im, 30+$desfase, 30, 5, 5, $white);
    break;

    case '4': imagefilledellipse($im, 10+$desfase, 10, 5, 5, $white);
    imagefilledellipse($im, 30+$desfase, 10, 5, 5, $white);
    imagefilledellipse($im, 10+$desfase, 30, 5, 5, $white);
    imagefilledellipse($im, 30+$desfase, 30, 5, 5, $white);
    break;

    case '5': imagefilledellipse($im, 10+$desfase, 10, 5, 5, $white);
    imagefilledellipse($im, 30+$desfase, 10, 5, 5, $white);
    imagefilledellipse($im, 20+$desfase, 20, 5, 5, $white);
    imagefilledellipse($im, 10+$desfase, 30, 5, 5, $white);
    imagefilledellipse($im, 30+$desfase, 30, 5, 5, $white);
    ...
    case '6': imagefilledellipse($im, 10+$desfase, 10, 5, 5, $white);
